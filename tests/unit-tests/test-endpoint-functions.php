...
class Test_Charitable_Endpoints_Functions extends Charitable_UnitTestCase {
	...
	public function test_is_campaign_donation_page_strict() {
		...
		$page = charitable_get_permalink( 'campaign_donation', array( 'campaign_id' => self::$campaign_id ) );

		$this->go_to( $page );

		$this->assertTrue( charitable_is_page( 'campaign_donation', array( 'strict' => true ) ) );
	}
	...
	public function test_is_not_campaign_donation_page_strict() {
		...
		$this->assertFalse( charitable_is_page( 'campaign_donation', array( 'strict' => true ) ) );
	}
